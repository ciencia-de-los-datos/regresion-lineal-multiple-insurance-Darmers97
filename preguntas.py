        ...
        steps=[
            ...
            (
                ...
                make_column_transformer( #tome las columnas transformadas 
                    (
                        OneHotEncoder(), 
                        make_column_selector(dtype_include=object) #solo seleccione las columnas categorías
                    ),
                    remainder='passthrough', #si tuviera drop con las columnas no trsnaformadas las pasarian
                ),
            ),
...
def pregunta_04():
    ...
    y_train_pred = gridSearchCV.predict(X_train) #toma todas las características (6) 
